<%-- 
    ...
    Created on : 12 mar. 2022, 5:48:15 p. m.
    Author     : Oscar
--%>
                ...
                <div class="gtco-container">
                    <div class="row">
                        <div class="col-md-8 col-md-offset-2 text-center gtco-heading">
                            ...
                            <p>Revisa los datos antes de confirmar tu vuelo</p>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-md-12 fh5co-card-item" style="padding-left: 0px;">
                            ...
                            List<Vuelo> list = dao.listar(request.getParameter("id"));
                            ...
                            <form action="ControladorConfirmarAgendar" method="post">
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-md-12">
                                            <div class="col-md-12">
                                                <div style="margin-top: 25px;">                                            
                                                    <label for="fullname">Numero de pasajeros</label>
                                                    <input type="number" min="1" value="1" name="pasajeros" class="form-control">                                            
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div style="margin-top: 30px;">
                                                    <div class="fh5co-text">                                               
                                                        <h3>x <%= cd.getPrecio()%> $</h3>                                                
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <input type="hidden" name="id_vuelo" value="<%= cd.getId()%>">
                                    <input type="hidden" name="precio" value="<%= cd.getPrecio()%>">
                                    ...
                                    <div class="col-md-12" style="margin-bottom: 20px">
                                        <a href="agendar.jsp" class="btn btn-primary btn-block">Volver</a>                                      
                                    </div>
